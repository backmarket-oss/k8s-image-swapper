...
LABEL maintainer="k8s-image-swapper <https://github.com/backmarket-oss/k8s-image-swapper/issues>" \
      ...
      org.opencontainers.image.vendor="backmarket-oss" \
      ...
      org.label-schema.vcs-url="git@github.com:backmarket-oss/k8s-image-swapper.git" \
      org.label-schema.vendor="backmarket-oss" \
